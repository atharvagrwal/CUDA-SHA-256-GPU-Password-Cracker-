...
// Simple wrapper around std::array for SHA-256 hash
struct Hash32 {
    std::array<uint8_t, 32> data;

    bool operator==(const Hash32& other) const {
        return data == other.data;
    }
    
    // Add data() member functions for compatibility
    ...
    // Add operator[] for array-like access
